...
public class RobotContainer {
  ...
  public HashMap<Integer, Command> getAcceptCommands() {
    ...
    _acceptCommands.put(5,
        runAutoOutake(Constants.IntakeStates.kAmpOpenHeight, Constants.IntakeStates.kAmpOpenRotation));
  ...
  private void configureBindings() {
    ...
    _joystick.povRight()
        .onTrue(runAutoOutake(Constants.IntakeStates.kAmpOpenHeight, Constants.IntakeStates.kAmpOpenRotation));
    _joystick.povLeft()
        .onTrue(runAutoOutake(Constants.IntakeStates.kTrapOpenHeight, Constants.IntakeStates.kTrapOpenRotation));
    ...
    _joystick2.L1().whileTrue(Commands.startEnd(() -> {
      _intakeElevator.setElevatorMotor(-1);
    }, () -> {
    ...
    _joystick2.triangle().whileTrue(Commands.startEnd(() -> {
      _intakeRotation.setRotationMotor(1);
    }, () -> {
      _intakeRotation.stopRotation();
    }, _intakeRotation));
    _joystick2.cross().whileTrue(Commands.startEnd(() -> {
      _intakeRotation.setRotationMotor(-1);
    }, () -> {
      _intakeRotation.stopRotation();
    }, _intakeRotation));
